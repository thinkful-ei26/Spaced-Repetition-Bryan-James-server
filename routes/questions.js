...
questionRouter.post('/data', (req, res, next) => {
  ...
  return User.findOne({ _id: userId }).then(currentUser => {
    ...
    let nextQuestion = qArray[whichQuestion].next
    let updatePackage = { head: nextQuestion, questions: qArray }
    ...
    if (answer === theRight.toLowerCase()) {
      ...
      let captureNewSpot = qArray[helperIndexValue].next
